...
<div class="main-header">
    ...
    <p>Tác giả: Vũ Kim Tuyến - Trường Tiểu học Cốc Pài - ĐT: 0912 568 804</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vũ Kim Tuyến - Trường Tiểu học Cốc Pài  - ĐT: 0912 568 804</div>", unsafe_allow_html=True)
